...
class UpdateRankKafkaProducer(sqlCredentials: SqlCredentials, selectSql: String, kafkaBrokers: String, topic: String) extends HighLevelKafkaProducer(kafkaBrokers, topic) {
