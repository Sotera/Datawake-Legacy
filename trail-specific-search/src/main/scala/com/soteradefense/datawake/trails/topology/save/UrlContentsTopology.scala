...
object UrlContentsTopology {
  def main(args: Array[String]): Unit = {
    ...
    topologyBuilder.setBolt("save-html", new SaveRawHtmlBolt(sqlCredentials, rawHtmlInsert, new Fields("sqlOrg", "sqlDomain", "sqlTrail", "sqlUrl", "sqlTitle")))
      .shuffleGrouping("html-contents-spout")

    topologyBuilder.setBolt("save-url", new SaveUrlBolt(sqlCredentials, insertNewUrlAndRankSql, new Fields("org", "domain", "trail", "url")))
