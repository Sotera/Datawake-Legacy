...
class HBASEDataConnector(ExtractedDataConnector):
    def __init__(self, conf):
        ...
        self.extracted_domain_tabile = table_prefix + conf['hbase_extracted_domain_table'].encode()
    ...
    def insert_domain_entities(self, domain, url, entity_type, entity_values):
        ...
        self.insertHBASE(rowkey_prefix, entity_values, self.extracted_domain_tabile)
