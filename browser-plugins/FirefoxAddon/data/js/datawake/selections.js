self.on("click", function (node, contextItemDataProperty) {
    var messageWrapper = {};
    if (contextItemDataProperty == "selection" || contextItemDataProperty == "feedback" || contextItemDataProperty == "add-trail-entity" || contextItemDataProperty == "add-irrelevant-trail-entity") {
