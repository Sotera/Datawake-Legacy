...
if ENTITY_CONNECTION != 'mysql' and ENTITY_CONNECTION != 'cluster':
    raise ValueError("DW_CONN_TYPE must be 'mysql' or 'cluster' if set. ")
...
HBASE_HOST = ''
if 'DW_HBASE_HOST' in os.environ:
    HBASE_HOST = os.environ['DW_HBASE_HOST']
